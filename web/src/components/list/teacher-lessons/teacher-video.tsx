...
import { LessonItemVideo } from '../lessons/lesson-item-video';
...
export const TeacherVideo = ({ selectedLessonItem, onPressNextLesson , isLastLessonItem, isCompleted,onPressPreviousLesson,isFirstLessonItem }: Props) => {
    return (
        <div className="w-full h-full p-[24px] overflow-y-auto opacity-0 animate-fadeInRight">
            ...
            <div className="font-bold text-[16px] text-[#292521]">
