...
import { MdVideoLibrary, MdCloudDownload } from 'react-icons/md'

export const AdminCourseDetails = ({ courseData }: any) => {
    ...
    return (
        <div className="w-full h-full border px-8 py-8 space-y-5">
