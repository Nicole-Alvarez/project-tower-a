...
export const WYSIWYG = ({ selectedLessonItem, onPressNextLesson, isLastLessonItem, isCompleted ,onPressPreviousLesson,isFirstLessonItem}: Props) => {
    ...
    return (
        <div className="w-full h-full overflow-y-auto opacity-0 animate-fadeInRight">
            <div className="font-bold text-[24px] text-[#292521] p-4">
